...
import { StyleSheet, View,TouchableOpacity,StatusBar,SafeAreaView,Platform ,Text,Image} from "react-native";
  ...
  signInWithGoogleAsync = async () => {
    try {
      const result = await Google.logInAsync({
        behaviour: "web",
        androidClientId:
          "527368689120-h8rq4om41p5hjahhr0hg8lpt3qfr570r.apps.googleusercontent.com",
        iosClientId:
          "527368689120-vaahrsra033310ihuie22gtvbg7ml8au.apps.googleusercontent.com",
