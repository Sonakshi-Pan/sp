...
export default class StoryCard extends Component {
  ...
  likeAction = () => {
    ...
    .child(this.state.story_id) .child("likes") .set(firebase.database.ServerValue.increment(-1));
     this.setState({ likes: (this.state.likes -= 1), isLiked: false }); }
     else { firebase .database() .ref("posts") 
...
const styles = StyleSheet.create({
  ...
  likeButtonLiked: { width: RFValue(160), 
    height: RFValue(40), 
    justifyContent: "center", 
    alignItems: "center", 
    flexDirection: "row", 
